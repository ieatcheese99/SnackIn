        ...
        <div class="left-side">
            <div class="brand-section">
                ...
                <div class="welcome-content">
                    ...
                    <p>Daftarkan diri Anda dan nikmati berbagai produk makanan ringan berkualitas tinggi dengan
                        pengalaman berbelanja yang menyenangkan.</p>
                </div>
            ...
            <div class="register-form">
                ...
                <form method="POST" id="registerForm">
                    <div class="form-group">
                        ...
                        <small style="color: #666; font-size: 0.75rem; margin-top: 0.25rem; display: block;">Username
                            hanya boleh mengandung huruf, angka, dan underscore</small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control with-icon" id="confirm_password"
